<template>
    <div class="container py-5">
      <h1 class="text-center mb-5 glow-text">My Portfolio</h1>
  ...
  <script setup>
  // We don't need any reactive state for this simple page
  // but the composition API script setup is ready for future expansions
  </script>
